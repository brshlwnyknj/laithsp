				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label"> رقم البوث</label>
			...
			<div class="col-md-8">
				<div class="card">
					<div class="card-header">
						...
						<br/>
							<br/>
							<a href="index.php?page=payment_report" class="btn btn-sm btn-outline-primary view_payment">	<button class="btn btn-sm btn-outline-primary view_payment" type="button"  >عرض تقارير البوثات</button></a>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										<p>رقم البوث #: <b><?php echo $row['house_no'] ?></b></p>
										<p><small> اسم المعرض: <b><?php echo $row['cname'] ?></b></small></p>
										<p><small>الوصف: <b><?php echo $row['description'] ?></b></small></p>
										<p><small>السعر: <b><?php echo number_format($row['price'],2) ?></b></small></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_house" type="button" data-id="<?php echo $row['id'] ?>"  data-house_no="<?php echo $row['house_no'] ?>" data-description="<?php echo $row['description'] ?>" data-category_id="<?php echo $row['category_id'] ?>" data-price="<?php echo $row['price'] ?>" >تعديل</button>
										<button class="btn btn-sm btn-danger delete_house" type="button" data-id="<?php echo $row['id'] ?>">حذف</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
