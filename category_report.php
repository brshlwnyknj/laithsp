						...
						<div class="row">
							<table class="table table-bordered">
								...
								<tbody>
									...
									inner join categories c on c.id = '$id'
									inner join houses h on h.category_id = c.id 
									inner join tenants t on t.house_id = h.id 
									where c.id = '$id'
...
<script>
	...
	$('#filter-report').submit(function(e){
		e.preventDefault()
		location.href = 'index.php?page=category_report&'+$(this).serialize()
	})
</script>